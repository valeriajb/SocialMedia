  ...
  return (
    <div className={"container-nav " + (currentMode && "dark")}>
      <div className="container-left">
        <span className={"logo-navBar " + (currentMode && "dark")}>
          lamasocial
        </span>
        ...
        {!currentMode ? (
          <BsMoonFill
            ...
            className={"iconNav " + (currentMode && "dark")}
          />
        ) : (
          <BsFillSunFill onClick={changeCurrentMode} className="iconNavSun" />
        )}
        ...
        <div className="container-search">
          ...
          <input
            type="text"
            className={"input-search " + (currentMode && "dark")}
            placeholder="Buscar..."
          />
        </div>
      </div>
